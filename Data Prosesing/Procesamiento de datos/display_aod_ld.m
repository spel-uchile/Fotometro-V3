...
while day_end >= day_ind
    ...
    for j=1:1:length(sub_folder(:,1))
        ...
        calibracion = strcat('Calb3/',sub_folder(j,:));
        load(calibracion);
            ...
            if (dig == unidad)
                ...
                if ~isempty(index_aero)
                    ...
                    if ~isempty(fs1)
                        ...
                        aod1 = aod_2(s1(fs1),r(fs1),p(fs1),m(fs1),v01,lambda1,delta1);
                        ...
                        title('Sensor 0');
                        hold off;
                        saveas(fig1, strcat('aod_3/',unidad,'_s1_',place,'_',num2str(year_a),'_',num2str(month_a),'_',num2str(day_a),'.fig'));
                        saveas(fig1, strcat('aod_3/',unidad,'_s1_',place,'_',num2str(year_a),'_',num2str(month_a),'_',num2str(day_a),'.png'));
                    ...
                    if ~isempty(fs2)
                        ...
                        aod2 = aod_2(s2(fs2),r(fs2),p(fs2),m(fs2),v02,lambda2,delta2);
                        ...
                        title('Sensor 1');
                        hold off;
                        saveas(fig2, strcat('aod_3/',unidad,'_s2_',place,'_',num2str(year_a),'_',num2str(month_a),'_',num2str(day_a),'.fig'));
                        saveas(fig2, strcat('aod_3/',unidad,'_s2_',place,'_',num2str(year_a),'_',num2str(month_a),'_',num2str(day_a),'.png'));
                    ...
                    if ~isempty(fs3)
                        ...
                        aod3 = aod_2(s3(fs3),r(fs3),p(fs3),m(fs3),v03,lambda3,delta3);
                        ...
                        title('Sensor 2');
                        hold off;
                        saveas(fig3, strcat('aod_3/',unidad,'_s3_',place,'_',num2str(year_a),'_',num2str(month_a),'_',num2str(day_a),'.fig'));
                        saveas(fig3, strcat('aod_3/',unidad,'_s3_',place,'_',num2str(year_a),'_',num2str(month_a),'_',num2str(day_a),'.png')); 
                    ...
                    if ~isempty(fs4)
                        ...
                        aod4 = aod_2(s4(fs4),r(fs4),p(fs4),m(fs4),v04,lambda4,delta4);
                        ...
                        title('Sensor 3');
                        hold off;
                        saveas(fig4, strcat('aod_3/',unidad,'_s4_',place,'_',num2str(year_a),'_',num2str(month_a),'_',num2str(day_a),'.fig'));
                        saveas(fig4, strcat('aod_3/',unidad,'_s4_',place,'_',num2str(year_a),'_',num2str(month_a),'_',num2str(day_a),'.png'));                
    ...
    if flag
        ...
        title('All');
        hold off;
        saveas(figure(5), strcat('aod_3/','All','_',num2str(year_a),'_',num2str(month_a),'_',num2str(day_a),'.fig'));
        saveas(figure(5), strcat('aod_3/','All','_',num2str(year_a),'_',num2str(month_a),'_',num2str(day_a),'.png'));  
    end
