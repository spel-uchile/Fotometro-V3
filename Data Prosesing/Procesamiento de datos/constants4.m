function out = constants4(aero, stgo, lt, ln, dig)
...
%longitud de onda fija
    ...
    while mn < length(aero.date)
        ...
        if ~isempty(index_stgo)
            ...
            ir1_340 = interp1(aero.datenum(index_aero), aero.aod_340(index_aero), stgo.datenum(valid1_pc),'linear','extrap');    
            ir1_440 = interp1(aero.datenum(index_aero), aero.aod_440(index_aero), stgo.datenum(valid1_pc),'linear','extrap');
            ams_1 = interp1(aero.datenum(index_aero), amstrong(index_aero), stgo.datenum(valid1_pc),'linear','extrap');
            hig_1 = interp1(aero.datenum(index_aero), high_wl(index_aero), stgo.datenum(valid1_pc),'linear','extrap');
    
            ir2_340 = interp1(aero.datenum(index_aero), aero.aod_340(index_aero), stgo.datenum(valid2_pc),'linear','extrap');    
            ir2_440 = interp1(aero.datenum(index_aero), aero.aod_440(index_aero), stgo.datenum(valid2_pc),'linear','extrap');
            ams_2 = interp1(aero.datenum(index_aero), amstrong(index_aero), stgo.datenum(valid2_pc),'linear','extrap');
            hig_2 = interp1(aero.datenum(index_aero), high_wl(index_aero), stgo.datenum(valid2_pc),'linear','extrap');
    
            ir3_340 = interp1(aero.datenum(index_aero), aero.aod_340(index_aero), stgo.datenum(valid3_pc),'linear','extrap');    
            ir3_440 = interp1(aero.datenum(index_aero), aero.aod_440(index_aero), stgo.datenum(valid3_pc),'linear','extrap');
            ams_3 = interp1(aero.datenum(index_aero), amstrong(index_aero), stgo.datenum(valid3_pc),'linear','extrap');
            hig_3 = interp1(aero.datenum(index_aero), high_wl(index_aero), stgo.datenum(valid3_pc),'linear','extrap');
    
            ir4_340 = interp1(aero.datenum(index_aero), aero.aod_340(index_aero), stgo.datenum(valid4_pc),'linear','extrap');    
            ir4_440 = interp1(aero.datenum(index_aero), aero.aod_440(index_aero), stgo.datenum(valid4_pc),'linear','extrap');
            ams_4 = interp1(aero.datenum(index_aero), amstrong(index_aero), stgo.datenum(valid4_pc),'linear','extrap');
            hig_4 = interp1(aero.datenum(index_aero), high_wl(index_aero), stgo.datenum(valid4_pc),'linear','extrap');
    ...
    %Interpolacion de datos
    ir1_340 = interp1(aero.datenum, aero.aod_340, stgo.datenum(s_valid1),'linear','extrap');    
    ir1_440 = interp1(aero.datenum, aero.aod_440, stgo.datenum(s_valid1),'linear','extrap');
    ams_1 = interp1(aero.datenum, amstrong, stgo.datenum(s_valid1),'linear','extrap');
    hig_1 = interp1(aero.datenum, high_wl, stgo.datenum(s_valid1),'linear','extrap');
    
    ir2_340 = interp1(aero.datenum, aero.aod_340, stgo.datenum(s_valid2),'linear','extrap');    
    ir2_440 = interp1(aero.datenum, aero.aod_440, stgo.datenum(s_valid2),'linear','extrap');
    ams_2 = interp1(aero.datenum, amstrong, stgo.datenum(s_valid2),'linear','extrap');
    hig_2 = interp1(aero.datenum, high_wl, stgo.datenum(s_valid2),'linear','extrap');
    
    ir3_340 = interp1(aero.datenum, aero.aod_340, stgo.datenum(s_valid3),'linear','extrap');    
    ir3_440 = interp1(aero.datenum, aero.aod_440, stgo.datenum(s_valid3),'linear','extrap');
    ams_3 = interp1(aero.datenum, amstrong, stgo.datenum(s_valid3),'linear','extrap');
    hig_3 = interp1(aero.datenum, high_wl, stgo.datenum(s_valid3),'linear','extrap');
    
    ir4_340 = interp1(aero.datenum, aero.aod_340, stgo.datenum(s_valid4),'linear','extrap');    
    ir4_440 = interp1(aero.datenum, aero.aod_440, stgo.datenum(s_valid4),'linear','extrap');
    ams_4 = interp1(aero.datenum, amstrong, stgo.datenum(s_valid4),'linear','extrap');
    hig_4 = interp1(aero.datenum, high_wl, stgo.datenum(s_valid4),'linear','extrap');
